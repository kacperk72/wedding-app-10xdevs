...
- [ ] **Migracja `20260710120000_guest_diet_kids` do wypchnięcia** — plik jest na dysku, ale nie zrobiono `npx supabase db push` (Supabase MCP wymaga logowania OAuth). Do czasu pushu dieta `kids` przejdzie walidację backendu, ale INSERT/UPDATE odbije się o CHECK-constraint w bazie. Push przed użyciem nowej diety na produkcji.
